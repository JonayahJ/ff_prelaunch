    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tech_exp_text', models.CharField(max_length=200)),
                ('tech_founder', models.CharField(choices=[('yes', 'Yes'), ('no', 'No'), ('other', 'Other')], max_length=50)),
                ('tech_founder_text', models.CharField(max_length=200)),
                ...
                ('startup_stage_text', models.CharField(max_length=200)),
                ...
                ('access_freq_text', models.CharField(max_length=200)),
                ...
                ('roadblocks_text', models.CharField(max_length=200)),
