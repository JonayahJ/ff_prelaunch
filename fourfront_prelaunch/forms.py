...
class SurveyForm(forms.Form):
    ...
    tech_exp_text                   =   forms.CharField(max_length=255, required=False)
    # Q2
    tech_founder                    =   forms.ChoiceField(widget=forms.RadioSelect, choices=YNO_CHOICES)
    tech_founder_text               =   forms.CharField(max_length=255, required=False)
    # Q3
    startup_stage                   =   forms.ChoiceField(widget=forms.RadioSelect, choices=STARTUP)
    startup_stage_text              =   forms.CharField(max_length=255, required=False)
    # Q4
    ...
    access_freq_text                =   forms.CharField(max_length=255, required=False)
    # Q6
    ...
    roadblocks_text                 =   forms.CharField(max_length=255, required=False)
    # Q8
    timeline                        =   forms.ChoiceField(widget=forms.RadioSelect, choices=TIMELINE)
    timeline_text                   =   forms.CharField(max_length=255, required=False)
    # Q9
    subscriber_first_name           =   forms.CharField(label="First Name", max_length=100)
    subscriber_last_name            =   forms.CharField(label="Last Name", max_length=100)
    subscriber_email                =   forms.EmailField(label="Email", widget=forms.EmailInput, min_length=10)